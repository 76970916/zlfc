...
public class SimplicityFragment extends BaseFragment<IHomeView, HomePresenter> implements IHomeView {
    ...
    public static SimplicityFragment newInstance() {
        Bundle args = new Bundle();
        SimplicityFragment fragment = new SimplicityFragment();
