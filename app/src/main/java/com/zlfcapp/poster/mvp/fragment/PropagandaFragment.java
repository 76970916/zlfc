...
public class PropagandaFragment extends BaseFragment<IHomeView, HomePresenter> implements IHomeView {
    ...
    public static PropagandaFragment newInstance() {
        ...
        PropagandaFragment fragment = new PropagandaFragment();
