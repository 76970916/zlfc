...
public class SPUtils {
    ...
    public static SPUtils getInstance() {
        return getInstance("mySp",App.mContext);
    }
     ...
     * @return {@link SPUtils}
     */
    public static SPUtils getInstance(String spName,Context mContext) {
        if (isSpace(spName)) spName = "spUtils";
        SPUtils sp = sSPMap.get(spName);
        if (sp == null) {
            sp = new SPUtils(spName,mContext);
            sSPMap.put(spName, sp);
        }
        return sp;
    }

    private SPUtils(String spName,Context mContext) {
        if (mContext == null){
